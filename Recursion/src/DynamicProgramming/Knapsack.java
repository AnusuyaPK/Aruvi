...
public class Knapsack {
    ...
    public static int findMaxProfit( int maxCapacityOfBag, int[] itemProfitArray, int[] itemWeightArray, int avlCapacity, int n ) {
        ...
        // Main Logic
        // Take
        int maxProfitByTakingItem = itemProfitArray[n-1] + findMaxProfit(maxCapacityOfBag, itemProfitArray, itemWeightArray, maxCapacityOfBag-itemWeightArray[n-1], n-1);

        // Don't Take
        int maxProfitByNotTakingItem = findMaxProfit(maxCapacityOfBag, itemProfitArray, itemWeightArray, maxCapacityOfBag, n-1);
